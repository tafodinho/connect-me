class PostsController < ApplicationController
  ...
  def update
    respond_to do |format|
      if @post.update(post_params)
        format.html { redirect_to :controller => 'static_pages', :action => 'home', notice: 'Post was successfully updated.' }
  ...
  def destroy
    @post.destroy
    respond_to do |format|
      format.html { redirect_to :controller => 'static_pages', :action => 'home', notice: 'Post was successfully deleted.' }
